...
public final class KVServer_reviewer extends DefaultRecoverable  {
    public final static String DEFAULT_CONFIG_FOLDER = "./config_reviewer/";
    private int id;
    ...
    public KVServer_reviewer(int id){ //throws IOException {
        this.id = id;
